...
--
-- Host: mysql.wwonline.com.br    Database: wwonline07
-- ------------------------------------------------------
...
CREATE TABLE `endereco` (
  ...
  `uf_id` int(11) NOT NULL COMMENT 'chave estrageira do id da tabela uf',
  `municipio_id` int(11) NOT NULL COMMENT 'chave estrageira id da tabela municipio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'wwonline07'
--
...
-- Dump completed on 2022-08-17 21:30:28
